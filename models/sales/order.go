...
func (SalesOrder) AllowFilterFieldsAndOps() []string {
	return []string{"id:eq", "name:ilike", "name:like", "commitment-date:eq", "commitment-date:gt", "commitment-date:gte", "commitment-date:lt", "commitment-date:lte", "sales-quotation-id:eq", "accounting-payment-term-id:eq"}
}
